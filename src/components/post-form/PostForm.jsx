...
const PostForm = ({ post }) => {
    ...
    const submit = async (data) => {
        if (post) {
            const file = await data.featuredImage[0] ? service.uploadFile(data.featuredImage[0]) : null
            if (file) {
            ...
            const file = awaitservice.uploadFile(data.featuredImage[0])
            if (file) {
